...
#' @param linenumber lines of therapy number variable name,
#' Defoult: 'LineNumber'
#' @param drop_maintenance_therapy should you include maintenance
#' @param linenumber_upper_limit upper limit for LoT
#' @param n_common, Number of most common lines of therapy presented
