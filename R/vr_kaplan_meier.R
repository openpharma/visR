...
#' @param equation The equation for the KM estimate
#' @param title plot title
#' @param abbreviations passed to plot
#' @param variable_definitions passed to plot
#' @param N patients, subjects, etc.
