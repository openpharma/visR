...
#' @section Last update date: 2022-05-02
#'
...
#' T4.  The function removes all rows with NA values inside CNSR or AVAL
...
testthat::context("estimate_cox - T4. The function removes all rows with NA values inside CNSR or AVAL")

testthat::test_that("T4.1 The function removes all rows with NA values inside CNSR or AVAL", {
...
testthat::context("estimate_cox - T5. The function does not alter the calculation of survival::coxph")

testthat::test_that("T5.1 The function gives the same results as survival::coxph", {
...
testthat::context("estimate_cox - T6. The function adds additional information to the survfit object when available")
...
testthat::test_that("T6.1 The calculation is not affected by the addition of additional parameters", {
  ...
  ## visR
  survobj_visR <- visR::estimate_cox(data = adtte, equation  = "SEX + AGE", conf.int = 0.9)
...
testthat::context("estimate_cox - T7. The function call supports traceability")
