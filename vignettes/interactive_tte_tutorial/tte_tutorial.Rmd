...
A second release of [`visR`](https://openpharma.github.io/visR/) to CRAN is planned for October. It will include a few bug fixes and UX improvements. However, it will also add new features:
