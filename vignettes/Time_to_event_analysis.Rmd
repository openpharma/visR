...
visR overwrites the base::plot() function an there is a warning to that when the package is loaded. However, it only overwrites the base::plot() function for type survfit and wires calls for all other objects through to base::plot().
