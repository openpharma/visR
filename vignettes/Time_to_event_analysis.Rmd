...
visR overwrites the base::plot() function and there is a warning to that when the package is loaded. However, it actually only overwrites the survival:::plot.survfit() function for type survfit and wires calls for all other objects through to base::plot().
