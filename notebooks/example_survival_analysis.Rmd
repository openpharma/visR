...
# create table
# tab1_groups <- visR::vr_create_tableone(brca_cohort_tab1, strata = c("therapy"))

# use alternative summary function
# tab1_groups <- visR::vr_create_tableone(brca_cohort_tab1, strata = c("therapy"), summary_function = visR::vr_summarize)

# render table
# tab1_groups %>% vr_render_table(title = "Overview over BRCA patients - Baseline characteristics of study cohort stratified by treatment type", 
                                   datasource = DATASET)
```
...
vr_table_one(brca_cohort_tab1, title = "Overview over BRCA patients",
             ...
             datasource = DATASET, strata = c("therapy"))
```
