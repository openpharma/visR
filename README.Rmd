...
The `tableone` calculates and presents summary statistics in a table format. There are a few more customization options available, such as footnote and summary functions.
