...
[![R build status](https://github.com/openpharma/visR/workflows/R-CMD-check/badge.svg)](https://github.com/openpharma/visR/actions)
<!-- badges: end -->
...
contributors <- usethis::use_tidy_thanks() %>%
  paste0("[",.,"](https://github.com/",.,")",collapse = ", ") %>%
  cat()
```
